...
async function main() {
  ...
  const sampleItems = [
    { sku: 'ELEC001', barcode: '8850006510012', name: 'USB Charger 20W', description: 'Fast charging USB-C adapter', defaultPrice: 299.00, category: 'Electronics' },
    { sku: 'ELEC002', barcode: '8850006510029', name: 'Earphones Pro', description: 'Noise cancelling earphones', defaultPrice: 599.00, category: 'Electronics' },
    ...
    { sku: 'CLOTH001', barcode: '8850006530010', name: 'Cotton T-Shirt M', description: 'Premium cotton t-shirt', defaultPrice: 199.00, category: 'Clothing' },
    ...
    { sku: 'SNACK001', barcode: '8850006540018', name: 'Potato Chips 100g', description: 'Crispy salted chips', defaultPrice: 35.00, category: 'Snacks' },
